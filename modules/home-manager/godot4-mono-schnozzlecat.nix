...
with lib; let
  ...
  pkg = (pkgs.callPackage ../../pkgs/godot4-mono-schnozzlecat {}).godotPackages_4_7.godot-mono;
  export = (pkgs.callPackage ../../pkgs/godot4-mono-schnozzlecat {}).godotPackages_4_7.godot-mono.export-template;
  export-debug = (pkgs.callPackage ../../pkgs/godot4-mono-schnozzlecat {}).godotPackages_4_7.godot-mono.export-template-debug;
in {
